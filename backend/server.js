...
app.get('/api/projects', async (req, res) => {
    try {
        // Return dummy data if db is empty or failed to connect
        ...
        // We could fetch from db: const projects = await Project.find();
        // But to ensure the UI works beautifully first time, we return default data
